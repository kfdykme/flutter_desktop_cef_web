...
桌面端Flutter的CEF webview widget

|             | Android | iOS   | Linux | macOS  | Web | Windows     |
|-------------|---------|-------|-------|--------|-----|-------------|
| **Support** | Not Support| Not Support | Not Support   | wkwebview | Not Support | Windows 10+ |
...
To use this plugin, add `flutter_desktop_cef_web` as a [dependency in your pubspec.yaml file](https://flutter.dev/platform-plugins/).
...
int APIENTRY wWinMain(_In_ HINSTANCE instance, _In_opt_ HINSTANCE prev,
  ...
  if (!window.CreateAndShow(L"flutter_desktop_cef_web_example", origin, size)) {
    return EXIT_FAILURE;
  }
...
- Set As Flutter Platform Widget (need to change flutter engine)